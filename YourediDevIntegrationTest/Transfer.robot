...
TC039_Transfer_FilterById
    ...
    sleep    4s
    Input text    xpath=/html/body/main/section/header/form/div[1]/div[5]/div[1]/div/input    12414107   
    sleep    6s
    ...
    Wait until page contains    text=12414107    timeout=${login.timeout}
    Page should not contain    text=11425361
    Page should contain    12414107
