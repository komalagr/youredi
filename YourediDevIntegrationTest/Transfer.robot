...
TC039_Transfer_FilterById
    ...
    sleep    4s
    Input text    xpath=/html/body/main/section/header/form/div[1]/div[5]/div[1]/div/input    12204733    #for dev - 11303940, stage=43179132
    sleep    4s
    ...
    Wait until page contains    text=12204733    timeout=30s
    Page should not contain    text=11425361
    Page should contain    12204733
