...
TC039_Transfer_FilterById
    ...
    sleep    11s
    Input text    xpath=/html/body/main/section/header/form/div[1]/div[5]/div[1]/div/input    43731278    #for dev - 11303940, stage=43179132
    sleep    15s
    ...
    Page should contain    text=43731278
