...
Dev_TC21-Alerts_FilterByInfo
    ...
    Wait until page contains element    class=fa-bell    timeout=18s
...
Dev_TC21-Alerts_FilterByAssignedTo
    ...
    Sleep    8s
    Page should not contain    text=No alerts found
    Wait until page contains    text=1category    timeout=18s
...
TC039_Transfer_FilterById
    ...
    sleep    4s
    Input text    xpath=/html/body/main/section/header/form/div[1]/div[5]/div[1]/div/input    44574025    #for dev - 11303940, stage=43179132
    sleep    4s
    ...
    Wait until page contains    text=44574025    timeout=18s
    Page should not contain    text=11425361
    Page should contain    44574025
