...
TC039_Transfer_FilterById
    ...
    sleep    4s
    Input text    xpath=/html/body/main/section/header/form/div[1]/div[5]/div[1]/div/input    12159011    #for dev - 11303940, stage=43179132
    sleep    4s
    ...
    Wait until page contains    text=12159011
    Page should not contain    text=11425361
    Page should contain    12159011
...
TC31_Bug8642_ExtensionCanotBeDeleted_IfUsedInProcess
    ...
    Click Element    xpath=//*[@id="webide"]/main/section/section/div/div[1]/div[2]/div[2]/div/p/a[2]    #Select Service
    Sleep    6s
    Wait Until page contains element    class=fa-plug    timeout=40s
