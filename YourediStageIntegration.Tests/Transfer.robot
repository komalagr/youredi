...
TC039_Transfer_FilterById
    ...
    sleep    8s
    Input text    xpath=/html/body/main/section/header/form/div[1]/div[5]/div[1]/div/input    45798347    #for dev - 11303940, stage=43179132
    sleep    8s
    ...
    Wait until page contains    text=45798347    timeout=${login.timeout}
    Page should not contain    text=11425361
    Page should contain    45798347
